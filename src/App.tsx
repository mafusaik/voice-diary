  ...
  <div className="text-left">
    ...
    <span className="block text-sm font-black">
      {t.getOnAppStore}
        ...
        <footer className="mt-auto bg-white/20 dark:/40 border-t border-white/10 dark:border-slate-800/20 py-8">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 rounded-xl bg-gradient-to-tr from-sky-400 via-indigo-500 to-indigo-600 p-0.5 shadow-md flex items-center justify-center">
                <div className="w-full h-full rounded-[9px] bg-sky-100 dark: flex items-center justify-center overflow-hidden">
